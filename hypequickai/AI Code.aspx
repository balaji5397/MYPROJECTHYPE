                        ...
                        <div class="col-md-4">
                            <div class="speechcontent1">
                                ...
                                <div class="speechinput">
                                    ...
                                    <input type="text" class="speechtextbox" placeholder="New Code" />
                                </div>
                                <div class="uploadsp">
                                    <br />
                                    <span>Description<span style="color: red">*</span></h6><span style="float: right"><small>0/100</small></span></span>
                                    <textarea rows="3" cols="25" style="width: 100%" class="speechtextbox" placeholder="write a javascript function to generate a random string"></textarea>
                                    <br />
                                    <br />
